...
CC = gcc
CFLAGS = -Wall -O2
FILES = $(TSH) ./myspin ./mysplit ./mystop ./myint ./hello_world

all: $(FILES)

# For GDB
test: $(TSH)
	gcc $(FLAGS) -g3 -o tsh tsh.c
	gcc $(FLAGS) -g3 -o hello_world hello_world.c
...
test21: 
	$(DRIVER) -t trace21.txt -s $(TSH) -a $(TSHARGS)
test22: 
	$(DRIVER) -t trace22.txt -s $(TSH) -a $(TSHARGS)
...
rtest20:
	$(DRIVER) -t trace20.txt -s $(TSHREF) -a $(TSHARGS)
rtest21:
	$(DRIVER) -t trace21.txt -s $(TSHREF) -a $(TSHARGS)
rtest22:
	$(DRIVER) -t trace22.txt -s $(TSHREF) -a $(TSHARGS)
